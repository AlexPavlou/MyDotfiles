...
alias -g compile_all_suckless="cd ~/.git/dwm && doas make clean install && cd ../st && doas make clean install && cd ../dmenu && doas make clean install && cd ../dwmblocks && doas make clean install && cd"
alias -g cp="cp -riv"
