...
static const char *const autostart[] = {
        ...
        "setsid", "doas auto-cpufreq --live", NULL,
        "sh", "/home/alex/.scripts/wifi.sh", NULL,
        "sh", "/home/alex/.scripts/sound.sh", NULL,
        //"setsid", "slstatus -s | dwlb -status-stdin all", NULL,
        NULL /* terminate */
};
...
static const MonitorRule monrules[] = {
        ...
        { NULL,       0.5, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, 0, 0, 0, 0, 60, 1, 0},
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_n,          spawn,          { .v = newscmd}},
	{ MODKEY,                    XKB_KEY_a,          spawn,          { .v = audiocmd}},
	{ MODKEY,                    XKB_KEY_m,          spawn,          { .v = statcmd}},
	{ MODKEY,                    XKB_KEY_b,          spawn,          { .v = muttcmd}},
	...
	{ MODKEY,                    XKB_KEY_q,          setlayout,      {.v = &layouts[2]} },
