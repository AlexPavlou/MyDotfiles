...
_G.packer_plugins = {
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/base46",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["mason.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/mason.nvim",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/alex/.local/share/nvim/site/pack/packer/opt/ui",
